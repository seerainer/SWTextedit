...
public final class Widgets {
	...
	widgets.add(MenuWidget.newMenuItem(editMenu, "text_menu_edit_undo", Icons.undo, SWT.CTRL + 'Z', events.undo)); //$NON-NLS-1$
	widgets.add(MenuWidget.newMenuItem(editMenu, "text_menu_edit_redo", Icons.redo, SWT.CTRL + 'Y', events.redo)); //$NON-NLS-1$

	new MenuItem(editMenu, SWT.SEPARATOR);

	widgets.add(MenuWidget.newMenuItem(editMenu, "text_menu_edit_cut", Icons.cut, SWT.CTRL + 'X', events.cut)); //$NON-NLS-1$
	widgets.add(MenuWidget.newMenuItem(editMenu, "text_menu_edit_copy", Icons.copy, SWT.CTRL + 'C', events.copy)); //$NON-NLS-1$
	widgets.add(
	...
	widgets.add(MenuWidget.newMenuItem(fileMenu, "text_menu_file_new", Icons.newfile, SWT.CTRL + 'N', //$NON-NLS-1$
		events.newFile));
	widgets.add(MenuWidget.newMenuItem(fileMenu, "text_menu_file_open", Icons.open, SWT.CTRL + 'O', events.open)); //$NON-NLS-1$
	widgets.add(MenuWidget.newMenuItem(fileMenu, "text_menu_file_save", Icons.save, SWT.CTRL + 'S', events.save)); //$NON-NLS-1$
	...
	widgets.add(MenuWidget.newMenuItem(editPopup, "text_menu_edit_undo", Icons.undo, SWT.CTRL + 'Z', events.undo)); //$NON-NLS-1$
	widgets.add(MenuWidget.newMenuItem(editPopup, "text_menu_edit_redo", Icons.redo, SWT.CTRL + 'Y', events.redo)); //$NON-NLS-1$
	...
	widgets.add(MenuWidget.newMenuItem(editPopup, "text_menu_edit_copy", Icons.copy, SWT.CTRL + 'C', events.copy)); //$NON-NLS-1$
